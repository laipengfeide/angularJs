...
var historyManager = {
	...
	buildGrid:function(dataSource){
		...
		var hg = $(".main").height() - $(".contTitle").height() - 43;
        $("#resGrid").kendoGrid(
            {  /*selectable : "multiple",*/
                sortable: true,
                resizable: true,
                ...
                title : '报警时间',
                width:"150px",
                template:"<div title='#:reportTime#' style='width: 190px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;'>#:reportTime#<div>"
            },{
                title : '区域编号',
                width:"100px",
                template:"<div title='#:areaCode#' style='width: 105px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;'>#:areaCode#<div>"
            },{
                title : '报警号码',
                width:"100px",
                template:"#if(deviceTypeName == 6){#<div title='#:number#' style='width: 150px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;'>#:number#<div>#}else{#"
                +"<div title='#:number#' style='width: 150px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;'>#:number#<div>#}#"
            },{
                title : '推送机构编号',
                //width:"40%",
                template:"<div title='#:organCodes#' style='word-wrap: break-word;white-space: normal;'>#:standardId#<div>"
            },{
                title : '推送对讲机编号',
                //width:"30%",
