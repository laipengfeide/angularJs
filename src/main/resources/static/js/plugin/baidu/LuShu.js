...
(function() {
    ...
    LuShu.prototype.clear = function() {
        this._map.removeOverlay(replayingTraceLayer._startMarker);
    	this._map.removeOverlay(replayingTraceLayer._endMarker);
    	this._map.removeOverlay(replayingTraceLayer._marker);
    	this._map.removeOverlay(replayingTraceLayer._overlay);
    	for (var i = 0, len = this._polylines.length; i < len; i++) {
    		var polyline = this._polylines[i];
    		this._map.removeOverlay(polyline);
    	}
    ...
    baidu.object.extend(LuShu.prototype, {
        ...
        _move: function(initPos,targetPos,effect) {
			...
			//20170601 nishaodong 显示折线
			var polyline = new BMap.Polyline(pointsArr,me._opts.lineStyle);
			me._polylines.push(polyline);
            me._map.addOverlay(polyline); 
			//20170601 nishaodong 信息窗显示实时时间
            target_pos.happenTime=targetPos.happenTime;
            //20170601 nishaodong 回调实现页面获得当前时间
            if (this.drawTraceTimeBack) this.drawTraceTimeBack(target_pos.happenTime);
            ...
            me._intervalFlag = setInterval(function() {
	            ...
	            if (currentCount >= count) {
	                ...
	                me._moveNext(++me.i);
                        ...
                        //nishaodong 信息窗显示实时时间,设置当前播放进度
                		pos.happenTime=target_pos.happenTime;
        ...
        */
        ...
        _moveNext: function(index) {
            ...
            if (index < this._path.length - 1) {
            	...
            	//20170601 nishaodong 移动完成后回调
            	if (this.drawTraceFinishBack) this.drawTraceFinishBack();
            }
        },
        /**
        ...
        _setInfoWin: function(pos) {
            ...
            if (index != -1) {
            	...
            	var info = me._opts.defaultContent;
            	if(pos.happenTime){
            		info+=" "+pos.happenTime;
            	}
            	me._overlay.setHtml(info);
            }
        },
        /**
         * 在某个点暂停的时间
